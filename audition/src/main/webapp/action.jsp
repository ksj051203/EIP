...
<%
	...
	String date2 = request.getParameter("date2"); if(date2.length()<2) date2="0" + date2;
	String date3 = request.getParameter("date3"); if(date3.length()<3) date3="0" + date3;
